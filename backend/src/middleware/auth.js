...
//       }
//     } catch (supabaseError) {
//       // Supabase verification failed, try JWT
//       console.log('Supabase auth failed, trying JWT...');
//     }

//     // Method 2: Try JWT token verification
//     if (!user) {
//       try {
...
//         }
//       } catch (jwtError) {
//         console.error('JWT auth failed:', jwtError.message);
//       }
//     }
...
//       super_admin: ['*'],
//       admin: [
//         'manage_users', 'manage_students', 'manage_visitors',
//         'manage_reports', 'manage_lockdown', 'manage_blacklist',
//         'manage_incidents', 'view_all_reports', 'view_all_incidents'
//       ],
//       guard: [
//         'scan_students', 'manage_visitors', 'report_incidents',
//         'submit_reports', 'view_lockdown', 'view_visitors'
//       ],
...
//         console.log(`[AUDIT] User: ${req.user.name} (${req.user.role}) | Action: ${action} | ${req.method} ${req.originalUrl} | Status: ${res.statusCode} | Auth: ${req.authMethod || 'unknown'}`);
//       }
